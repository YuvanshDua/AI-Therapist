...
TTS_PIPER_LENGTH_SCALE = float(os.environ.get("TTS_PIPER_LENGTH_SCALE", "1.08"))
TTS_PIPER_NOISE_SCALE = float(os.environ.get("TTS_PIPER_NOISE_SCALE", "0.6"))
TTS_PIPER_NOISE_W_SCALE = float(os.environ.get("TTS_PIPER_NOISE_W_SCALE", "0.9"))
TTS_PIPER_SENTENCE_SILENCE = float(os.environ.get("TTS_PIPER_SENTENCE_SILENCE", "0.26"))
TTS_PIPER_VOLUME = float(os.environ.get("TTS_PIPER_VOLUME", "1.0"))
TTS_MAX_INPUT_CHARS = int(os.environ.get("TTS_MAX_INPUT_CHARS", "800"))
